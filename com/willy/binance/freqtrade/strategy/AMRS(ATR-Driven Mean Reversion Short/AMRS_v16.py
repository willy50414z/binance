...
class AMRS_v16(IStrategy):
    ...
    def custom_exit(self, pair: str, trade: 'Trade', current_time: 'datetime', current_rate: float,
        ...
        # 摩擦成本牆：利潤小於 0.4% 時，除非持倉過久，否則絕對不賣
        if current_profit < 0.004 and trade_duration < 360:  # 提高到 0.4%
            return None

        # 強力獲利保護：當利潤 > 2% 時，才把追蹤止損縮緊到 0.1%
        if current_profit > 0.02:
            self.trailing_stop_positive = 0.001
        else:
